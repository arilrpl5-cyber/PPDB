    ...
    <div class="flex w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100 relative">
        ...
        <div class="w-full p-8 md:p-12">
            <div class="text-center mb-10">
                ...
                <p class="text-gray-500 mt-2 text-sm md:text-base">Lengkapi data diri Anda di bawah ini secara benar untuk membuat akun penerimaan Peserta Didik baru.</p>
            </div>
            ...
            <form action="<?php echo e(route('register')); ?>" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input id="name" name="name" type="text" value="<?php echo e(old('name')); ?>" required placeholder="Contoh: Budi Santoso" class="appearance-none block w-full px-4 py-3.5 border border-gray-200 rounded-xl shadow-sm bg-gray-50 text-[#0F172A] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#2563EB]/50 focus:border-[#2563EB] sm:text-sm transition-all duration-300 font-medium">
                    </div>
                    ...
                    <div>
                        ...
                        <input id="phone" name="phone" type="text" value="<?php echo e(old('phone')); ?>" required placeholder="081234567890" class="appearance-none block w-full px-4 py-3.5 border border-gray-200 rounded-xl shadow-sm bg-gray-50 text-[#0F172A] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#2563EB]/50 focus:border-[#2563EB] sm:text-sm transition-all duration-300 font-medium">
                    </div>
                ...
                <div class="pt-8 border-t border-gray-100 flex flex-col-reverse sm:flex-row items-center justify-between gap-6">
                    <p class="text-sm text-gray-500 font-medium">
                        Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="text-[#2563EB] font-bold hover:text-[#1E3A8A] transition-colors duration-200">Masuk di sini &rarr;</a>
                    </p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\RPL-04\Downloads\PMB-Laravel-10-main\PMB-Laravel-10-main\resources\views\auth\register.blade.php ENDPATH**/ ?>