...
<div class="mb-8">
    ...
    <p class="text-sm text-gray-500 font-medium">Ringkasan statistik penerimaan Peserta Didik baru dan performa sistem ujian.</p>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow">
        ...
        <p class="text-4xl font-black text-[#0F172A]"><?php echo e($stats['total_pendaftar']); ?></p>
    </div>
    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow">
        ...
        <p class="text-4xl font-black text-[#0F172A]"><?php echo e($stats['total_ikut_ujian']); ?></p>
    </div>
    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow">
        ...
        <p class="text-4xl font-black text-emerald-600"><?php echo e($stats['total_lulus']); ?></p>
    </div>
    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow">
        ...
        <p class="text-4xl font-black text-red-600"><?php echo e($stats['total_gagal']); ?></p>
    </div>
    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow xl:col-span-2">
        ...
        <p class="text-4xl font-black text-[#1E3A8A]"><?php echo e($stats['total_daftar_ulang']); ?> <span class="text-sm font-medium text-gray-400">Berkas Verifikasi</span></p>
    </div>
    ...
    <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow xl:col-span-2">
        ...
        <h4 class="text-gray-500 text-sm font-bold uppercase tracking-wider mb-2">Siswa Resmi</h4>
        <p class="text-4xl font-black text-[#2563EB]"><?php echo e($stats['total_mahasiswa']); ?> <span class="text-sm font-medium text-gray-400">Siswa</span></p>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\RPL-04\Downloads\PMB-Laravel-10-main\PMB-Laravel-10-main\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>