        ...
        <div class="w-full md:w-5/12 bg-[#1E3A8A] flex flex-col justify-center items-start p-10 md:p-12 relative overflow-hidden">
            ...
            <div class="relative z-10 w-full">
                ...
                <h1 class="text-3xl lg:text-4xl font-extrabold text-white leading-tight mb-4 tracking-tight">
                    Sistem Penerimaan<br><span class="text-[#F59E0B]">Peserta Didik Baru</span>
                </h1>
                <p class="text-blue-100 text-sm md:text-base leading-relaxed mb-8 opacity-90">
                    Portal resmi pendaftaran dan ujian masuk Smk Bagimu Negeriku. Langkah pertama menuju masa depan cemerlang dimulai di sini.
                </p>
                ...
                <div class="flex items-center space-x-3 bg-[#0F172A]/40 p-4 rounded-xl backdrop-blur-sm border border-white/10 shadow-inner">
                    ...
                    <p class="text-xs text-blue-50">Belum punya akun? <a href="<?php echo e(route('register')); ?>" class="font-bold text-[#F59E0B] hover:text-white transition ease-in-out duration-200">Daftar sekarang &rarr;</a></p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\RPL-04\Downloads\PMB-Laravel-10-main\PMB-Laravel-10-main\resources\views/auth/login.blade.php ENDPATH**/ ?>