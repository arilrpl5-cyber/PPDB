            ...
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-blue-50/50 transition-colors group">
                        ...
                        <td class="px-6 py-5">
                            <div class="text-[13px] font-extrabold text-[#0F172A] mb-3 leading-loose"><?php echo e($question->question); ?></div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs font-medium">
                                <div class="flex items-start <?php echo e($question->correct_answer === 'A' ? 'text-emerald-700 bg-emerald-50 border-emerald-100' : 'text-gray-600 border-gray-100'); ?> border p-2 rounded-lg">
                                    <span class="font-extrabold w-5 flex-shrink-0 <?php echo e($question->correct_answer === 'A' ? 'text-emerald-600' : 'text-gray-400'); ?>">A.</span>
                                    <span><?php echo e($question->option_a); ?></span>
                                </div>
                                <div class="flex items-start <?php echo e($question->correct_answer === 'B' ? 'text-emerald-700 bg-emerald-50 border-emerald-100' : 'text-gray-600 border-gray-100'); ?> border p-2 rounded-lg">
                                    <span class="font-extrabold w-5 flex-shrink-0 <?php echo e($question->correct_answer === 'B' ? 'text-emerald-600' : 'text-gray-400'); ?>">B.</span>
                                    <span><?php echo e($question->option_b); ?></span>
                                </div>
                                <div class="flex items-start <?php echo e($question->correct_answer === 'C' ? 'text-emerald-700 bg-emerald-50 border-emerald-100' : 'text-gray-600 border-gray-100'); ?> border p-2 rounded-lg">
                                    <span class="font-extrabold w-5 flex-shrink-0 <?php echo e($question->correct_answer === 'C' ? 'text-emerald-600' : 'text-gray-400'); ?>">C.</span>
                                    <span><?php echo e($question->option_c); ?></span>
                                </div>
                                <div class="flex items-start <?php echo e($question->correct_answer === 'D' ? 'text-emerald-700 bg-emerald-50 border-emerald-100' : 'text-gray-600 border-gray-100'); ?> border p-2 rounded-lg">
                                    <span class="font-extrabold w-5 flex-shrink-0 <?php echo e($question->correct_answer === 'D' ? 'text-emerald-600' : 'text-gray-400'); ?>">D.</span>
                                    <span><?php echo e($question->option_d); ?></span>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-5 text-center">
                            <span class="inline-flex items-center justify-center px-2.5 py-1 rounded-md bg-blue-100 text-[#1E3A8A] font-bold text-xs border border-blue-200 shadow-sm">
                                <?php echo e($question->weight); ?> Point
                            </span>
                        </td>
                        <td class="px-6 py-5 text-center">
                            <div class="flex items-center justify-center space-x-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                
                                <button type="button" @click="openEdit(<?php echo e(json_encode($question)); ?>)" class="text-amber-500 hover:text-amber-700 hover:bg-amber-50 p-2 rounded-lg transition-colors border border-transparent hover:border-amber-200" title="Edit Soal">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                </button>

                               
                                <button type="button" @click="confirmDelete('<?php echo e($question->id); ?>')" class="text-red-500 hover:text-red-700 hover:bg-red-50 p-2 rounded-lg transition-colors border border-transparent hover:border-red-200" title="Hapus Soal">
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('questionManager', () => ({
            isModalOpen: false,
            mode: 'create', 
            formAction: '<?php echo e(route('admin.questions.store')); ?>',
            formData: {
                id: '',
                question: '',
                option_a: '',
            ...
            openCreate() {
                this.mode = 'create';
                this.formAction = '<?php echo e(route('admin.questions.store')); ?>';
                this.formData = {
                    id: '',
                    question: '',
                    option_a: '',
