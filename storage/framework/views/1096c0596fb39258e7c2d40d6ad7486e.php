...
<div class="mb-8">
    <div class="flex items-center space-x-4 mb-4">
        <a href="<?php echo e(route('admin.questions.index')); ?>" class="inline-flex items-center justify-center w-10 h-10 bg-white border border-gray-200 rounded-full shadow-sm text-gray-500 hover:text-[#2563EB] hover:border-[#2563EB] hover:bg-blue-50 transition-all duration-200" title="Kembali ke Bank Soal">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 bg-gray-50 border border-gray-100 rounded-xl p-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="option_a" value="<?php echo e(old('option_a', $question->option_a)); ?>" required class="pl-10 appearance-none block w-full px-4 py-3 border border-gray-200 rounded-lg shadow-sm text-[#0F172A] focus:outline-none focus:ring-2 focus:ring-[#2563EB]/50 focus:border-[#2563EB] sm:text-sm transition-all duration-300">
                    </div>
                </div>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="option_b" value="<?php echo e(old('option_b', $question->option_b)); ?>" required class="pl-10 appearance-none block w-full px-4 py-3 border border-gray-200 rounded-lg shadow-sm text-[#0F172A] focus:outline-none focus:ring-2 focus:ring-[#2563EB]/50 focus:border-[#2563EB] sm:text-sm transition-all duration-300">
                    </div>
                </div>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="option_c" value="<?php echo e(old('option_c', $question->option_c)); ?>" required class="pl-10 appearance-none block w-full px-4 py-3 border border-gray-200 rounded-lg shadow-sm text-[#0F172A] focus:outline-none focus:ring-2 focus:ring-[#2563EB]/50 focus:border-[#2563EB] sm:text-sm transition-all duration-300">
                    </div>
                </div>
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="option_d" value="<?php echo e(old('option_d', $question->option_d)); ?>" required class="pl-10 appearance-none block w-full px-4 py-3 border border-gray-200 rounded-lg shadow-sm text-[#0F172A] focus:outline-none focus:ring-2 focus:ring-[#2563EB]/50 focus:border-[#2563EB] sm:text-sm transition-all duration-300">
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div>
                    ...
                    <select name="correct_answer" required class="appearance-none block w-full px-4 py-3 border border-gray-200 rounded-xl shadow-sm text-[#0F172A] font-bold bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 sm:text-sm transition-all duration-300 cursor-pointer">
                        <option value="A" <?php echo e($question->correct_answer=='A'?'selected':''); ?>>Opsi A</option>
                        <option value="B" <?php echo e($question->correct_answer=='B'?'selected':''); ?>>Opsi B</option>
                        <option value="C" <?php echo e($question->correct_answer=='C'?'selected':''); ?>>Opsi C</option>
                        <option value="D" <?php echo e($question->correct_answer=='D'?'selected':''); ?>>Opsi D</option>
                    </select>
                </div>
                <div>
                    ...
                    <div class="relative">
                        <input type="number" name="weight" value="<?php echo e(old('weight', $question->weight)); ?>" required min="1" max="100" class="appearance-none block w-full px-4 py-3 pr-16 border border-gray-200 rounded-xl shadow-sm text-[#0F172A] font-bold bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#2563EB]/50 focus:border-[#2563EB] sm:text-sm transition-all duration-300">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\RPL-04\Downloads\PMB-Laravel-10-main\PMB-Laravel-10-main\resources\views\admin\questions\edit.blade.php ENDPATH**/ ?>