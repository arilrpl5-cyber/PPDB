                ...
                @else
                    ...
                    @if(($result->is_passed ?? 'PENDING') === 'PENDING')
                        <div class="text-center py-6">
                            ...
                            <p class="text-sm text-gray-500 font-medium">Kami telah menerima lembar jawaban Anda dengan perolehan skor awal <span class="font-extrabold text-[#1E3A8A]">{{ $result->total_score ?? 0 }}</span>. Silakan tunggu review final kelulusan dari Panitia PPDB.</p>
                        </div>
                    <
