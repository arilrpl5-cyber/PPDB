    ...
    <div class="w-full max-w-6xl text-center md:text-left flex flex-col md:flex-row items-center gap-12 lg:gap-20">
        ...
        <div class="flex-1 space-y-8">
            ...
            <h1 class="text-5xl md:text-6xl lg:text-7xl font-black text-[#0F172A] tracking-tighter leading-[1.1]">
                ...
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#1E3A8A] to-[#2563EB]">Peserta Didik Baru</span> <br/>
                Berbasis Web
            </h1>
            ...
            <div class="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm shadow-[#1E3A8A]/5 relative overflow-hidden group hover:border-blue-200 transition-colors duration-300 max-w-xl">
                ...
                <div class="flex items-start space-x-5 relative z-10">
                    ...
                    <div class="text-left pt-1">
                        <p class="text-[13px] font-bold text-gray-500 mb-1 leading-relaxed">Proyek ini dibuat oleh [Nama Anda] dengan tujuan merancang dan mengembangkan sebuah sistem informasi berbasis web berupa Portal PPDB (Penerimaan Peserta Didik Baru). Sistem ini dirancang untuk mempermudah proses pendaftaran siswa secara online, pengelolaan data pendaftar, hingga proses seleksi dan pengumuman hasil secara efisien dan terstruktur.</p>
                        <h3 class="text-2xl font-black text-[#0F172A] uppercase tracking-wider mb-0.5">Aril Steven SItohang</h3>
                        <p class="text-sm font-extrabold text-[#F59E0B] inline-flex items-center">
                            Kelas X PPLG <span class="mx-2 text-gray-300">|</span> SMK BAGIMU NEGERIKU
                        </p>
                    </div>
                </div>
            </div>
