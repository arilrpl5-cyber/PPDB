...
<div class="mb-8">
    <div class="flex items-center space-x-4 mb-4">
        <a href="<?php echo e(route('admin.users.index')); ?>" class="inline-flex items-center justify-center w-10 h-10 bg-white border border-gray-200 rounded-full shadow-sm text-gray-500 hover:text-[#2563EB] hover:border-[#2563EB] hover:bg-blue-50 transition-all duration-200" title="Kembali ke Daftar Peserta">
        ...
        <form action="<?php echo e(route('admin.users.update', $user->id)); ?>" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div>
                    ...
                    <input type="text" name="name" value="<?php echo e(old('name', $user->name)); ?>" required placeholder="Contoh: Budi Santoso" class="appearance-none block w-full px-4 py-3 border border-gray-200 rounded-xl shadow-sm text-[#0F172A] bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#2563EB]/50 focus:border-[#2563EB] sm:text-sm transition-all duration-300 font-medium">
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="phone" value="<?php echo e(old('phone', $user->profile?->phone)); ?>" required placeholder="81234567890" class="pl-12 appearance-none block w-full px-4 py-3 border border-gray-200 rounded-xl shadow-sm text-[#0F172A] bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#2563EB]/50 focus:border-[#2563EB] sm:text-sm transition-all duration-300 font-medium">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\RPL-04\Downloads\PMB-Laravel-10-main\PMB-Laravel-10-main\resources\views\admin\users\edit.blade.php ENDPATH**/ ?>